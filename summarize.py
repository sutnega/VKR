...
PROVIDER_DEFAULTS: Dict[str, Dict[str, Any]] = {
    ...
    "openai": {
        ...
        "description": "OpenAI API — платно (~$0.05 за 500 новостей)",
    },
    "ollama": {
        "model": "llama3",
...
def call_openai(title: str, summary: Optional[str], api_key: str, model: str) -> str:
    """
...
def call_provider(
    ...
    try:
        if provider == "gemini":
            ...
            return call_openai(title, summary, api_key, model)
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Резюмирование новостей через LLM (Gemini / Groq / OpenAI / Ollama)",
